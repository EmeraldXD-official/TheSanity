...
namespace TheSanity.Items.CheatBook
{
    public class CheatManipulation : ModProjectile
    {
        ...
        {
            var debugPlayer = Main.player[Projectile.owner].GetModPlayer<DebugPlayer>();
            
            int finalDamage = debugPlayer.RmbDamage + (target.defense / 2);
            modifiers.SourceDamage = new StatModifier(0f, 1f, finalDamage, 0f);
