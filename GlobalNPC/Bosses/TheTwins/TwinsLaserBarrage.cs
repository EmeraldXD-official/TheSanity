...
namespace YourModName.Content.NPCs
{
    ...
    public static class TwinsLaserBarrage
    {
        ...
        private const int RetLaserBeamDamage = 19; // Beam Predik: base 15 kena ~80 di game (rasio observasi ~5.33x) - dinaikin ke 19 buat target 100+
                ...
                case State.Firing:
                    {
                        ...
                        if (self.LaserBarrageShotsFired >= ShotsPerSide)
                        {
                            ...
                            if (self.IsEnraged)
                            {
                                ...
                                // Aim line keluar -> sound Zombie103, sama kayak RetBeam pas
                                // garis aim-nya nongol pertama kali.
        ...
        {
            Vector2 muzzlePos = npc.Center + direction * 30f;

            // Efek "laser lepas tembak" - sama persis pola yang dipakai RetBeam/CursedRain.
