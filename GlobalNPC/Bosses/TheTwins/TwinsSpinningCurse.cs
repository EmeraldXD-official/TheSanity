...
namespace YourModName.Content.NPCs
{
    ...
    // terus MUTER DI TEMPAT selama 15 detik penuh sambil nembakin CursedFlameHostile
    ...
    public static class TwinsSpinningCurse
    {
        ...
        private const int BackBoltDamage = 13; // RedBolt: target 40 DMG Master / 3 (engine auto-triples proyektil di Master mode)
