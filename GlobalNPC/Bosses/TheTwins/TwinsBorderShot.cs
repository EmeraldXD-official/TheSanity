...
namespace YourModName.Content.NPCs
{
    ...
    public static class TwinsBorderShot
    {
        ...
        private const int ShotDamage = 13; // RedBolt: target 40 DMG Master / 3 (engine auto-triples proyektil di Master mode)
        ...
        // 4-5 CursedFlameHostile sekaligus, masing-masing dari TITIK RANDOM berbeda di
        ...
        private const int CenterFlameDamage = 5; // Curse Bolt/Curse Ball: target 15 DMG Master / 3 (engine auto-triples proyektil di Master mode)
        ...
        public static void Start(NPC npc, TwinsReworkOverride self)
        {
            ...
            self.BorderShotLapsRequired = Main.rand.Next(MinLaps, MaxLapsInclusive + 1);
        ...
        // ---- ENRAGED (Phase 3): burst 4-5 CursedFlameHostile, MASING-MASING dari titik
