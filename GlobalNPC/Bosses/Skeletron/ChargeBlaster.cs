...
namespace TheSanity.GlobalNPC.Bosses.Skeletron
{
    ...
    {
        // FIX BARU (request user): laser gampang banget di-dodge — beam-nya
        // butuh 8 tick buat manjang penuh & baru damage aktif sesudah itu,
        // kasih waktu reaksi kebanyakan. Sekarang GrowTime dipangkas jauh
        // (8 -> 3, ~0.05 detik) biar begitu Fire() kepanggil beam-nya
        // LANGSUNG kerasa "nyambar" penuh & bahaya, bukan manjang pelan2
        // dulu. ActiveTime dinaikin dikit (14 -> 16) biar window damage-nya
        // tetep kerasa, TotalDuration keseluruhan malah jadi lebih pendek.
        const int GrowTime = 3;
        const int ActiveTime = 16;
