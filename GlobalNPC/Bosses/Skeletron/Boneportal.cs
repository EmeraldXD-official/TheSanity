...
namespace TheSanity.GlobalNPC.Bosses.Skeletron
{
    ...
    public class BonePortal : ModNPC
    {
        ...
        int EffectiveGrowthDuration => IsDashPortal ? DashGrowthDuration : GrowthDuration;
        int EffectiveEruptionTick => IsDashPortal ? DashEruptionTick : EruptionTick;
        int EffectivePostEruptionLifetime => IsDashPortal ? DashPostEruptionLifetime : PostEruptionLifetime;
