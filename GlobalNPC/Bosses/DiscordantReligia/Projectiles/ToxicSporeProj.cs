    ...
    public class ToxicSporeProj : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor) {
            ...
            BossGlowRenderer.DrawGlowCore(
                Main.spriteBatch, tex, drawPos, null, origin, Projectile.rotation, Projectile.scale,
                Color.Lerp(Color.SpringGreen, Color.Red, progress), Color.White,
                pulseSpeed: 6.0f + progress * 8.0f, rimPower: 2.5f, intensity: 1.0f + progress * 0.4f);
