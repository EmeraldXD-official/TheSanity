...
namespace TheSanity
{
    ...
    {
        public static int QuestionMarkHeadSlot { get; private set; }

        public override void Load() {
            // Pendaftaran Boss Head Texture HARUS di sini
            QuestionMarkHeadSlot = AddBossHeadTexture("TheSanity/GlobalNPC/Bosses/DiscordantReligia/QuestionMarkHead");
        }
    }
