...
namespace TheSanity
{
    public class SanityPlayer : ModPlayer
    {
        ...
        // 🧠 Status Imun dari Penambahan Sanity (Diaktifkan oleh Angler Tackle Bag, dll)
        public bool sanityImmunity = false;
        ...
        // 🔄 Reset status imun setiap frame awal
        public override void ResetEffects() {
            sanityImmunity = false;
        }
        ...
        public override void PostUpdateMiscEffects() {
            ...
            // 🛑 JIKA IMUN SANITY AKTIF: Nolkan gainPoints agar tidak bisa menambah Sanity!
            if (sanityImmunity) {
                gainPoints = 0;
            }
        ...
        // 🛑 JIKA IMUN SANITY AKTIF: Mencegah penambahan Sanity saat pemain menerima damage
